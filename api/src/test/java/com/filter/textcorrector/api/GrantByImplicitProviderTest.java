...
import com.filter.textcorrector.api.SwearCheckerApiApplication;
...
@SpringBootTest(classes = SwearCheckerApiApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
