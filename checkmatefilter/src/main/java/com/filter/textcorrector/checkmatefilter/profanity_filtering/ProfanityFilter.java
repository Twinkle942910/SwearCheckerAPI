package com.filter.textcorrector.checkmatefilter.profanity_filtering;

import com.filter.textcorrector.checkmatefilter.profanity_filtering.dictionary.Dictionary;
import com.filter.textcorrector.checkmatefilter.profanity_filtering.dictionary.DictionaryFactory;
...
public class ProfanityFilter {
    ...
    public static void main(String[] args) {
        ProfanityFilter profanityFilter = new Builder()
