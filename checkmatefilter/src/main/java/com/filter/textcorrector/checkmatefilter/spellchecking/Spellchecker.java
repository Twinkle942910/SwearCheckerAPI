package com.filter.textcorrector.checkmatefilter.spellchecking;

import com.filter.textcorrector.checkmatefilter.spellchecking.dictionary.Dictionary;
import com.filter.textcorrector.checkmatefilter.spellchecking.dictionary.DictionaryFactory;
import com.filter.textcorrector.checkmatefilter.spellchecking.model.Suggestion;
import com.filter.textcorrector.checkmatefilter.spellchecking.util.DamerauLevenshteinDistance;
import com.filter.textcorrector.checkmatefilter.spellchecking.util.Soundex;
import com.filter.textcorrector.checkmatefilter.text_preproccessing.TextPreproccessor;
import com.filter.textcorrector.checkmatefilter.text_preproccessing.util.CleanTextType;
import com.filter.textcorrector.checkmatefilter.text_preproccessing.util.TextUtils;
